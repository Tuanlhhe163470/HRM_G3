...
namespace HRM_Infrastructure.Migrations
{
    ...
    [Migration("20260317080453_AddShiftIdToOvertime")]
    partial class AddShiftIdToOvertime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM_Domain.Entities.AttendanceExplanation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("HRActionDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("AttendanceExplanations");
                });
            ...
            modelBuilder.Entity("HRM_Domain.Entities.LeaveBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM_Domain.Entities.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM_Domain.Entities.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM_Domain.Entities.SalaryAdvance", b =>
                {
            ...
            modelBuilder.Entity("HRM_Domain.Entities.TimeAttendance.OvertimeRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM_Domain.Entities.LeaveBalance", b =>
                {
                    ...
                    b.HasOne("HRM_Domain.Entities.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("HRM_Domain.Entities.TimeAttendance.OvertimeRequest", b =>
                {
                    ...
                    b.HasOne("HRM_Domain.Entities.TimeAttendance.ShiftConfig", "Shift")
                        .WithMany()
                        .HasForeignKey("ShiftId");
