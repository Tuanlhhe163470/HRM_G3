        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
          ...
          <div className="bg-white p-4 rounded-xl border border-purple-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="flex items-end gap-2 mt-1">
              ...
              <p
                className="text-sm font-bold text-purple-400 mb-1 border-l-2 border-purple-200 pl-2"
                title="Số ngày đã dùng phép"
              >
                    ...
                    {dayLogs.length > 0 && (
                      <div className="mt-2 flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {/* NẾU CÓ OT THÌ HIỂN THỊ MÀU XANH */}
                          {parseFloat(totalOT) > 0 && (
                            <span className="text-[9px] font-bold text-emerald-600 bg-emerald-100 px-1 rounded-sm">
                              +{totalOT}h OT
                            </span>
                          )}
                        </div>
                              ...
                              <div className="pl-10 mt-2 flex items-center justify-between">
                                <div>
                                  <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    {/* THÊM: NẾU CA NÀY CÓ GIỜ OT, HIỂN THỊ RIÊNG */}
                                    {logItem.overtimeHours > 0 && (
                                      <div className="inline-block px-2 py-1 bg-emerald-50 rounded text-xs font-bold text-emerald-700 border border-emerald-200 flex items-center gap-1">
                                        <span className="material-symbols-outlined text-[14px]">
                                          more_time
                                        </span>
                                        Làm thêm: {logItem.overtimeHours} giờ
                                      </div>
                                    )}
                                  </div>
                                  {logItem.note && (
